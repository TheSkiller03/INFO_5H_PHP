...
<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    if($coutUs == 1 && $coutPs == 1) {
      if($_POST['username'] == 'Andrea') {
        $usernameEr = '';
        if($_POST['password'] == 'Rossetti') {
          $passwordEr = '';
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
  ...
  <label for="username" type="testo" class="titoletto"></label><br>
  ...
  <label for="password" type="testo" class="titoletto"></label><br><br>
